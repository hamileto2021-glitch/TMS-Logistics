...
capacityWeightController.text =
v.capacityWeight.toString();

capacityVolumeController.text =
      ...
      onPressed: saving
        ...
        try {
          final vehicle = Vehicle(
            ...
            capacityWeight: double.tryParse(
                capacityWeightController.text
                    .trim()) ??
                0,
            capacityVolume: double.tryParse(
                capacityVolumeController.text
                    .trim()) ??
                0,
            fuelType:
            ...
            roadLicenseNumber:
            roadLicenseController.text.trim(),
            roadLicenseExpiry:
            roadLicenseExpiry,
