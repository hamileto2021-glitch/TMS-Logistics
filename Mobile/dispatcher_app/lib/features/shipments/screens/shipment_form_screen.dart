...
class ShipmentFormScreen extends StatefulWidget {
  ...
  @override
  State<ShipmentFormScreen> createState() =>
      _ShipmentFormScreenState();
}

class _ShipmentFormScreenState
    extends State<ShipmentFormScreen> {
        ...
        try {
          final shipment = Shipment(
            ...
            volume: double.tryParse(
                ...
                0,
            numberOfPackages: int.tryParse(
                packagesController.text.trim()) ??
                0,
            bookingDate: bookingDate,
            dispatchDate:
            widget.shipment?.dispatchDate,
            expectedDeliveryDate:
            expectedDeliveryDate,
            status: status,
